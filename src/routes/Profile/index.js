    ...
    return (
      <React.Fragment>
        <PageHeader
          ...
          action={
            <Button type="primary" onClick={() => Modal.alert({ message: '暂不支持同步配置文件功能' })}>
              同步
            </Button>
          }
            ...
            <Table
              columns={[
                ...
                },
                {
                  ...
                  key: 'team',
                  render: value =>
                    value ? <span className={styles.highlight}>是</span> : <span className={styles.muted}>否</span>,
                },
                {
                  title: '过滤作者',
                  ...
                  render: value =>
                    false === value ? (
                      <span className={styles.highlight}>否</span>
                    ) : (
                      <span className={styles.muted}>是</span>
                    ),
                },
                {
                  title: '操作',
